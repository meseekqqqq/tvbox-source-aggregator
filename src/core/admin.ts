...
<div class="container" id="mainContent" style="display:none">
  ...
  <div class="section">
    ...
    <div style="margin-top:8px;display:flex;gap:8px">
      ...
      <button class="btn btn-sm" onclick="importSeedData()" data-i18n="importSeed">Import Seed (23)</button>
    </div>
...
const translations = {
  en: {
    ...
    importSeed:'Import Seed (23)', submitBatch:'Submit Batch',
    ...
    noMacCMS:'No MacCMS sources. Add above or import seed data.',
    ...
    importConfirm:'Import 23 recommended MacCMS sources?',
  ...
  zh: {
    ...
    importSeed:'导入种子（23个）', submitBatch:'提交批量',
    ...
    loadingSources:'加载源中...',
    noMacCMS:'暂无 MacCMS 源。可在上方添加或导入种子数据。',
    ...
    importConfirm:'是否导入 23 个推荐 MacCMS 源？',
